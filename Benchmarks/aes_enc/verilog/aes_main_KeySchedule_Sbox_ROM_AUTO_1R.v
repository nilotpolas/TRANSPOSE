...
// ==============================================================
`timescale 1 ns / 1 ps
module aes_main_KeySchedule_Sbox_ROM_AUTO_1R (
...
initial begin
    $readmemh("./aes_main_KeySchedule_Sbox_ROM_AUTO_1R.dat", ram0);
    $readmemh("./aes_main_KeySchedule_Sbox_ROM_AUTO_1R.dat", ram1);
end
